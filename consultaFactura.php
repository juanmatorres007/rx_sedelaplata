...
if (isset($_POST['tipo_procedimiento']) && isset($_POST['mes_inicio']) && isset($_POST['tipo_entidad'])) {
    ...
    $sql = "SELECT f.id_factura, f.codigo_factura, f.nombre_archivo, p.codigo_procedimiento, p.nombre_procedimiento, p.marca,
    ...
    <input type='hidden' name='id_factura' value='{$row['id_factura']}'>
    <button id='editar' type='submit' style='background: none; border: none; cursor: pointer;' aria-label='editar'>
